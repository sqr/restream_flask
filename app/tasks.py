...
def restream(origin, server, stream_key):
    ...
    try:
        ...
        a1 = stream1.audio
        stream = ffmpeg.output(stream_ol, a1, stream_server, format='flv', vcodec='libx264', acodec='aac', preset='veryfast', g='50', crf='23', maxrate='4M', bufsize='5M', channel_layout='stereo')
