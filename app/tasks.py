...
def restream(origin, server, stream_key):
    ...
    try:
        ...
        a1 = stream1.audio
        stream = ffmpeg.output(stream_ol, a1, stream_server, format='flv', vcodec='libx264', s='1280x720', threads='1', acodec='aac', preset='veryfast', g='120', crf='23', maxrate='4M', bufsize='5M', channel_layout='stereo')
