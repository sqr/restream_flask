...
def marianizer():
    ...
    if form.submit.data and form.validate():
        ...
        subprocess.run(['download-twitter-resources', '-c', 'twitter_secrets.json', '--video', '--tweet', 'https://twitter.com/Cloutassent/status/1271888576725344257', ' video'], shell=False)
